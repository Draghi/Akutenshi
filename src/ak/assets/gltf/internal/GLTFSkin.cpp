...
akas::Skin akas::gltf::processGLTFSkin(const Asset& asset, const Skin& skin, gltfID nodeID, const std::unordered_map<gltfID, gltfID>& parentMap) {
	...
	std::vector<akas::Joint> jointHierarchy; jointHierarchy.reserve(jointSet.size());
