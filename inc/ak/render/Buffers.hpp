...
namespace akr {
	...
	void bindBuffer(akr::BufferTarget target, const Buffer& buffer, uint32 index, akSize offset, akSize size);
	void bindBuffer(akr::BufferTarget target, const Buffer& buffer, uint32 index);
	void bindBuffer(akr::BufferTarget target, const Buffer& buffer);
