...
#ifndef AK_ENGINE_COMPONENT_CAMERA_HPP_
#define AK_ENGINE_COMPONENT_CAMERA_HPP_
...
namespace ake {
	...
	class Camera final {
		...
		public:
			...
			EntityID entityID() const { return m_id; }
	};
	...
	class CameraManager final : public ComponentManager {
		...
		public:
			Camera& component(EntityID entityID) {
				return m_components.at(entityID);
			}

			const Camera& component(EntityID entityID) const {
				return m_components.at(entityID);
			}

			const std::unordered_map<EntityID, Camera>& components() const {
				return m_components;
			}
