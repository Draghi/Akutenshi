 ...
 * - Made header-only
 * - Placed in namespace
 * - Names and formatting changed to better suit engine's style
 * - Changed some data types to better suit engine's style
 * - Made use of some C++ features like function-local statics
 * - Changed std::string to std::vector<uint8> for decoding
 */

#ifndef AK_ENGINE_DATA_BASE64_HPP_
#define AK_ENGINE_DATA_BASE64_HPP_
...
#endif /* AK_ENGINE_DATA_BASE64_HPP_ */
