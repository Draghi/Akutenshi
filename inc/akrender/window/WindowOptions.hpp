...
#ifndef AK_RENDER_WINDOW_WINDOWOPTIONS_HPP_
#define AK_RENDER_WINDOW_WINDOWOPTIONS_HPP_
...
namespace akd {
	bool deserialize(akr::win::WindowOptions& dst, const akd::PValue& root);
	void serialize(akd::PValue& root, const akr::win::WindowOptions& val);
}
